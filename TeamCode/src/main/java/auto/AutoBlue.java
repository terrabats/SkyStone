...
public class AutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(rf.stonePos.equals(TerraCV.StonePos.RIGHT)){
            ...
            rf.intake(path2, 1);
            path2.addPose(9,1,30, true);
            path2.addPose(2,6,-10,false);
            path2.addPose(-15, -17, -20, false);
            grabStone(path2);
        ...
        if(rf.stonePos.equals(TerraCV.StonePos.RIGHT)){
            ...
            rf.intake(path3, 1);
            path3.addPose(8,1,30, true);
            path3.addPose(2,4,-10,false);
            path3.addPose(-13, -20, -20, false);
            grabStone(path3);
            path3.addPose(0,-40,0,false);
        }else {
            path3.addPose(4, 40, 0, true);
            rf.intake(path3, 1);
            path3.addPose(6,1,30, true);
            path3.addPose(2,6,-10,false);
