...
import autoUtil.DriveFunctions;
...
public class AutoRed extends LinearOpMode {
    ...
    private void initialize(){
        ...
        path2.setConstants(0.04,0.04,0.5,0.5,0.5,0.5);
