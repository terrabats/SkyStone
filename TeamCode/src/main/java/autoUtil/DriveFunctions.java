...
public class DriveFunctions {
    ...
    public double FORWARD_C = 100;
    public double STRAFE_C = 100;
    public double TURN_C = 100;
    public double FORWARD_A = 100;
    public double STRAFE_A = 100;
    public double TURN_A = 100;
    public double TIME_C;

    public void init(TerraBot t, TargetDetection td, LinearOpMode o) {
        bot = t;
        op = o;
        this.td = td;
    }
    public void setConstants(double fc, double sc, double tc, double fa, double sa, double ta, double time){
        this.FORWARD_C = fc;
        this.STRAFE_C = sc;
        this.TURN_C = tc;
        this.FORWARD_A = fa;
    ...
    public void start(Path path, LinearOpMode o){
        ...
        while (o.opModeIsActive() && path.isExecuting()){
            positions[0] = bot.l1.getCurrentPosition();
            positions[1] = bot.r1.getCurrentPosition();
            positions[2] = bot.r2.getCurrentPosition();
            positions[3] = bot.l2.getCurrentPosition();
            double[] pows = path.getPowers(positions, op.telemetry);
            if(pows!= null) {
